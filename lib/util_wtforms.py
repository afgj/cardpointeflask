...
from cardpointeflask.extensions import db
...
class ModelForm(BaseModelForm):
    ...
    inherit from flask_wtf's Form. So let's just copy this class directly.
...
def choices_from_dict(source, prepend_blank=True):
    """
    Convert a dict to a format that's compatible with WTForm's choice. It also
